...
@section('scripts')
    ...
    <script type="text/jsx">
		...
		var SwitchState = React.createClass({
			...
			render: function(){
				...
				if(this.props.checkState != ""){
					...
					if(this.props.checkState.status == 'SEARCHING'){
					...
					}else if((this.props.checkState.status == 'DROPPED' || this.props.checkState.status == 'COMPLETED') && this.props.checkState.payment_mode == 'SQUARE' && this.props.checkState.paid == 0){
						return (
							<div>
								<DroppedAndSquare checkState={this.props.checkState} currency={this.props.currency} />
							</div>
						);
						...
						return (
							<div>
								<DroppedAndBraintree checkState={this.props.checkState} currency={this.props.currency} />
							</div>
						);
					}else if(this.props.checkState.status == 'COMPLETED'){
						return (
		...
		var DroppedAndBraintree = React.createClass({
			...
			render: function(){
				...
				return (
				<div>
					<form method="POST" action="{{url('/braintree/flow')}}">
						{{ csrf_field() }}</input>
					<div className="status">
		                <h6>@lang('user.status')</h6>
		                <p>@lang('user.ride.dropped_ride')</p>
		...
		var DroppedAndSquare = React.createClass({
			...
			render: function(){
				...
				return (
				<div>
					<form method="POST" action="{{url('/square/flow')}}">
						{{ csrf_field() }}</input>
					<div className="status">
		                <h6>@lang('user.status')</h6>
		                <p>@lang('user.ride.dropped_ride')</p>
