...
<div class="col-md-12">
    <form role="form" method="POST" action="{{ url('/provider/login') }}">
        ...
        <div class="col-md-4 ">
         ...
         <div class="col-md-8 "> 
            <input type="phone" required id="phone_number" class="form-control" placeholder="Enter Phone Number" name="mobile" value="{{ old('mobile') }}" data-stripe="number"  maxlength="15" onkeypress="return isNumberKey(event);" />
