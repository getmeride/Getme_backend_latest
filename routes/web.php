...
Route::post('/braintree/flow', 'UserApiController@braintree_flow');
Route::post('/square/flow', 'UserApiController@square_flow');
...
Route::get('/filter/user/email/{filter}' , 'UserApiController@filter_user_email');
Route::get('/all/users' , 'UserApiController@all_users');
Route::post('/wallet/transfer' , 'UserApiController@wallet_transfer');
